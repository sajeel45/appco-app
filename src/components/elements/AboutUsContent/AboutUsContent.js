...
const AboutUsContent = () =>{
    return(
        <div className="about-us-content-wrapper" style={{backgroundImage:`url(${AboutUsBg})`}}>
            <Container>
                <Row>
                    <Col lg="8">
            ...
            <div className="about-us-button-wrapper">
                <Link to="/" className="about-us-buton-style">View All Members<span className="arrow-style"><FaArrowRight /></span></Link>
            </div>
            </div>
            </Col>
            </Row>
